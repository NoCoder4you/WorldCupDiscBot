...
class ClaimBetButton(discord.ui.View):
    ...
    async def claim_bet(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed.set_field_at(1, name=bet['option2'], value=interaction.user.mention, inline=False)
        embed.set_footer(
            text=f"{interaction.client.user.display_name}"
        )
...
class BettingCog(commands.Cog):
    ...
    async def process_bet(self, interaction: discord.Interaction, modal: BetModal):
        ...
        embed.set_footer(text=f"{interaction.client.user.display_name}")
